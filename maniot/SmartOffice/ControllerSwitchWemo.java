...
public class ControllerSwitchWemo{
    ...
    //private String HOST = "192.168.88.44:49153"; // gumstix
    //private String ip = "192.168.88.32";   // wemo
    ...
    public void Connect() throws Exception{
        ...
        try{
            ...
            url = new URL("http://"+switchIP+":"+port+"/upnp/control/basicevent1");
    ...
    public boolean ReadStatus() throws Exception{
        URL url = null;
        BufferedReader reader = null;
        ...
        try{
            ...
            connection.setRequestProperty("Host", hostIP+":"+port);
    ...
    private int getSignalStrength() throws Exception{
        URL url = null;
        BufferedReader reader = null;
    ...
    public void loadSwitchWemoProperties()
    {
        Properties prop = new Properties();
        InputStream input = null;

        try {
            input = new FileInputStream("SwitchWemo.properties");
            prop.load(input);
            hostIP = prop.getProperty("HOST_IP");
            port = prop.getProperty("PORT");
            switchIP = prop.getProperty("SWITCH_IP");
    ...
    public static void main(String[] args) throws Exception{
        ControllerSwitchWemo a= new ControllerSwitchWemo();
        a.SwitchOn();
    }
}
